...
<script type="text/html" id="tmpl-donate-form-template">
    <form action="<?php echo esc_attr(donate_redirect_url()) ?>" method="POST" class="donate_form" id="donate_form">
        <h2><?php esc_html_e('Donation amount', 'charitywp') ?></h2>
        <p class="description">{{ data.campaign_title }}
        <p>
                                    ...
                                    <# } #>
                                        ...
                                        <# if ( payment ) { #>
                                            ...
                                            <div class="donate_compensates">
                                                <ul>
                                                    <# if( typeof data.compensates !== 'undefined' && Object.keys(data.compensates).length >
                                                        0 ) { #>

                                                        <# jQuery.each( data.compensates, function(key, val) { #>
                                                            <li>
                                                                <input type="radio" name="donate_input_amount_package"
                                                                       value="{{ key }}" id="{{ key }}"/>
        ...
        <li>
            <h4><?php esc_html_e('Enter custom donate amount', 'charitywp'); ?></h4>
        ...
        <div class="donate_donor_info">
            ...
            <div class="donate_field">
                <input name="first_name" id="first_name" class="first_name"
                       placeholder="<?php _e('* First Name', 'tp-donate') ?>"/>
            </div>

            <div class="donate_field">
                <input name="last_name" id="last_name" class="last_name"
                       placeholder="<?php _e('* Last Name', 'tp-donate') ?>"/>
            </div>
            ...
            <div class="donate_field">
                <textarea name="address" id="address" class="address"
                          placeholder="<?php _e('* Address', 'tp-donate') ?>"></textarea>
            </div>

            <div class="donate_field">
                <textarea name="addition" id="addition" class="addition"
                          placeholder="<?php _e('Additional note', 'tp-donate') ?>"></textarea>
            </div>
        ...
        <div class="donate_payment_method">
            ...
            <label class="payment_method" for="payment_method_{{ payment.id }}"><img width="115" height="50"
                                                                                     src="{{ payment.icon }}"/></label>
        ...
        <div class="donate_form_footer center">
            ...
            <button type="submit" class="donate_submit button payment"
                    form="donate_form"><?php _e('Donate', 'tp-donate') ?></button>
        ...
        <div class="donate_form_footer">
            ...
            <button type="submit" class="donate_submit button"
                    form="donate_form"><?php _e('Donate', 'tp-donate') ?></button>
