...
function thim_template_path() {
    return Thim_Theme_Wrapper::$main_template;
}
...
function thim_template_base() {
    return Thim_Theme_Wrapper::$base;
}

/**
 * Theme wrapper class
 */
class Thim_Theme_Wrapper {
...
add_filter('template_include', array('Thim_Theme_Wrapper', 'wrap'), 99);
