...
$list                  = $instance['list_group']['content'];
$list_color            = $instance['list_group']['text_color'];
...
// CSS Style
$box_css = $title_css = $description_css = $overlay_css = $before_title = $after_title = $before_box = $after_box = $list_css = '';
...
if ( $list != '' ) :
    $html .= '<div class="list" style="' . $list_css . '">' . $list . '</div>';
endif;
