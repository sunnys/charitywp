...
if ( $campaigns->have_posts() ) { ?>
    <div class="thim-campaign tpl-campaign-list-2" id="<?php echo esc_attr( $campaign_box ); ?>">
            ...
            if ( $campaigns->have_posts() ) {
                while ( $campaigns->have_posts() ) {
                    ...
                    <div <?php post_class( 'campaign' ) ?> >
                        <div class="inner">
                            <div class="content">
                                <p class="widget-title"><?php echo esc_attr($instance['title']) ?></p>
                            ...
                            if ( $src ) {
                                ...
                                $img_src     = $src['0'];
                                $imgH        = $images_size[1];
                                if ( $images_size[0] >= 600 && $images_size[1] >= 355 ) {
                                    $img_src = aq_resize( $src[0], 600, 355, true );
                                    $imgH    = 355;
                                }
                                ?>
                                <div class="media">
