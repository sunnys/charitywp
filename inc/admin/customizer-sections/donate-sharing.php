...
thim_customizer()->add_field(
	array(
		...
		'tooltip'  => esc_html__( 'Show the facebook sharing option in donate.', 'charitywp' ),
		'section'  => 'donate_share',
		'default'  => false,
		'priority' => 11,
		'choices'  => array(
...
thim_customizer()->add_field(
	array(
		...
		'tooltip'  => esc_html__( 'Show the Twitter sharing option in donate.', 'charitywp' ),
		'section'  => 'donate_share',
		'default'  => false,
		'priority' => 12,
		'choices'  => array(
...
thim_customizer()->add_field(
	array(
		...
		'tooltip'  => esc_html__( 'Show the Google Plus sharing option in donate.', 'charitywp' ),
		'section'  => 'donate_share',
		'default'  => false,
		'priority' => 13,
		'choices'  => array(
...
thim_customizer()->add_field(
	array(
		...
		'tooltip'  => esc_html__( 'Show the Pinterest sharing option in donate.', 'charitywp' ),
		'section'  => 'donate_share',
		'default'  => false,
		'priority' => 14,
		'choices'  => array(
...
thim_customizer()->add_field(
	array(
		...
		'tooltip'  => esc_html__( 'Show the Fancy sharing option in donate.', 'charitywp' ),
		'section'  => 'donate_share',
		'default'  => false,
		'priority' => 15,
		'choices'  => array(
