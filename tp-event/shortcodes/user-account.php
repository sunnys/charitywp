...
if ( !is_user_logged_in() ) {
	printf( esc_html__( 'You are not <a href="%s">login</a>', 'charitywp' ), tp_event_login_url() );
	return;
}
    ...
    <table>
		...
		<?php foreach ( $query->posts as $post ): ?>
            ...
            <tr>
                ...
                <td><?php printf( '%s', $booking->payment_id ? tp_event_get_payment_title( $booking->payment_id ) : __( 'No payment', 'charitywp' ) ) ?></td>
