...
<div class="thimpress_donate_form">
    <form action="<?php echo esc_attr( donate_redirect_url() ) ?>" method="POST" class="donate_form" id="donate_form">
        <h2><?php _e( 'Donation amount', 'charitywp' ) ?></h2>
			...
			<?php if ( $payments || !$campaign_id ) : ?>
                ...
                <div class="donate_compensates">
                    <ul>
                        ...
                        <li>
                            <h4><?php _e( 'Enter custom donate amount: ', 'charitywp' ); ?></h4>
                ...
                <div class="donate_donor_info">
                    ...
                    <h3><?php _e( 'Personal Info', 'charitywp' ) ?></h3>

                    <div class="donate_field">
                        <input name="first_name" id="first_name" class="first_name" placeholder="<?php _e( '* First Name', 'charitywp' ) ?>" />
                    </div>

                    <div class="donate_field">
                        <input name="last_name" id="last_name" class="last_name" placeholder="<?php _e( '* Last Name', 'charitywp' ) ?>" />
                    </div>

                    <div class="donate_field">
                        <input name="email" id="email" class="email" placeholder="<?php _e( '* Email', 'charitywp' ) ?>" />
                    </div>

                    <div class="donate_field">
                        <input name="phone" id="phone" class="phone" placeholder="<?php _e( '* Phone', 'charitywp' ) ?>" />
                    </div>

                    <div class="donate_field">
                        <textarea name="address" id="address" class="address" placeholder="<?php _e( '* Address', 'charitywp' ) ?>"></textarea>
                    </div>

                    <div class="donate_field">
                        <textarea name="addition" id="addition" class="addition" placeholder="<?php _e( 'Additional note', 'charitywp' ) ?>"></textarea>
                    </div>
				...
				<?php if ( $enable === 'yes' && $term_condition_page_id ) : ?>
                    ...
                    <div class="donate_term_condition">
                        ...
                        <label for="term_condition">
							<?php _e( 'Terms & Conditions', 'charitywp' ); ?>
                        </label>
                    </div>
...
//				endif;
                ...
                <div class="donate_form_footer center">
                    ...
                    <button type="submit" class="donate_submit button payment" form="donate_form"><?php _e( 'Donate', 'charitywp' ) ?></button>
			...
			<?php else: ?>
                ...
                <div class="donate_form_footer">
                    ...
                    <button type="submit" class="donate_submit button" form="donate_form"><?php _e( 'Donate', 'charitywp' ) ?></button>
